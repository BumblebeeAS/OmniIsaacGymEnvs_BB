...
class BBAUVView(ArticulationView):
    def __init__(self, prim_path_exp: str, name: Optional[str] = "BBAUVView"):
        super().__init__(prim_paths_expr=prim_path_exp, name=name, reset_xform_properties=False)
        ...
        self.disturbance = RigidPrimView(
            prim_paths_expr="/World/envs/.*/BBAUV/auv4_disturbance_link", name="disturbance"
        )
